...
| ACT-007 | ~~Implement observer probes and capability-state evidence~~ | ~~Adapter maintainer~~ | CLOSED | Superseded by Observer Adapter Surface Contract v0.2/v0.3 (contract.py + evidence.py) | Closed by implementation |
...
| ACT-009 | ~~Define common semantic/coverage probe contract~~ | ~~Architecture + adapter maintainers~~ | CLOSED | Superseded by contract.py surface validation + capability_states fleet guarantee test | Closed by implementation |
