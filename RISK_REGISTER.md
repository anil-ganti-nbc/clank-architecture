...
| R-005 | Duplicate architecture repositories imply conflicting authority. | High | ADR-0001 assigns roles and supersedes `unified-clank-platform`. | Conformance links resolve to one governance and one implementation authority. |
